...
export class User {
    ...
    @OneToMany(() => Facility, facility => facility.provider, {nullable: true, 
        onDelete: 'SET NULL', cascade: true, eager: true})
    managedFacilities: Facility[];
    ...
    @OneToMany(() => Booking, booking => booking.user, {nullable: true, onDelete: 'CASCADE',
    cascade: true})
    bookings: Booking[];
