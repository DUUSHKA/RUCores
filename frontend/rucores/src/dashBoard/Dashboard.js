...
function Dashboard() {
   ...
   * transactionList
   */
  const transactionListItems = transactionHistoryData.history.map((transaction, index) => {
    if (index < 4) {
    ...
    <>
      <div className="dashboard">
        ...
        <div className="dashboard-sections">
          ...
          <section className="transactions">
            ...
            <div>
              <ListGroup className="HistoryList" variant="flush">{transactionListItems}</ListGroup>
              <Link to="/wallet">
      ...
      <div className="weekCard">
        <div className="WeeklyCard">
          <div className='WeeklyCardTitle'><h3>MONDAY</h3></div>
        ...
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>TUESDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>WEDNESDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>THURSDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>FRIDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>SATURDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
        <div className='WeeklyCard'>
          <div className='WeeklyCardTitle'><h3>SUNDAY</h3></div>
          <div className='WeeklyCardContent'></div>
        </div>
